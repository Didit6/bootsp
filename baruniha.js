var imgFree = "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjyiPDJhwYAjWK8exTJHs4LS06OaEz_H4lcsdXx12V6ScJSy7D4JqtFSf9VGYML5sf3h93TFgd8VvMQtAu01n-VpAefNMBeNQZODpUVkMMsLCPGYEyAxiTdY_9DMgbfSfsugFaKD6i5Yr4dzVysVksiSFE5UUJ8Vrtp8wrCsablpbTqvMJYZQS7fwsm/s1600/AddText_05-13-07.41.06.png";
// Create grid container A
var cnms = document.getElementById("tekschrd");
...
var gidc1 = document.createElement('div');
gidc1.setAttribute("id","grd1");
document.getElementById("DIV1").appendChild(gidc1);
for(a=0;a<47;a++){
...
var btnx1 = document.createElement("div");
btnx1.innerHTML = nmsx1[a];
btnx1.setAttribute("class","koloms1");
document.getElementById("grd1").appendChild(btnx1);
}
var tmbl1 = document.getElementsByClassName("koloms1");
tmbl1[0].onclick = function(){
	cnms.innerHTML = nmsx1[0];
...
tmbl1[1].onclick = function(){
	cnms.innerHTML = nmsx1[1];
	gbr1.src = "https://1.bp.blogspot.com/-lZlYR5Rssks/YMYJUlo1fVI/AAAAAAAAARo/L95q4TDZJTsTAH0Th1oZd00qSMeIPGdmgCPcBGAYYCw/s0/AddText_06-10-04.25.33.png";
	gbr2.src = "https://1.bp.blogspot.com/-6d_11Qn52uo/YMYJUsp_iYI/AAAAAAAAARo/KUiJWE8J4mkDX8HJoKYxjN6jRI5cnFhWgCPcBGAYYCw/s0/AddText_06-10-04.21.42.png";
	gbr3.src = "https://1.bp.blogspot.com/-0sh1rOLA6-8/YMYJUUvW9kI/AAAAAAAAARs/32zKlp9x9UcKdobL1jxBKVgw4FBKelSYgCPcBGAYYCw/s0/AddText_06-10-04.18.06.png";
	gbr4.src = imgFree;
	
}
tmbl1[2].onclick = function(){
	cnms.innerHTML = nmsx1[2];
	gbr1.src = "https://1.bp.blogspot.com/-2dgxXgDh03I/YMYJVpsbAAI/AAAAAAAAARI/YmI6tl7QV5QbHz5FLV9DWn9V3wg4SkE1wCPcBGAYYCw/s0/AddText_06-10-04.39.23.png";
	gbr2.src = "https://1.bp.blogspot.com/-NC7gVUa40Lg/YMYJV326IqI/AAAAAAAAARA/hELhph_kJgALCMWfQgxCm7nSuv3iuWajgCPcBGAYYCw/s0/AddText_06-10-04.36.42.png";
	gbr3.src = "https://1.bp.blogspot.com/-0eMUlc9_p8w/YMYJVUiIcoI/AAAAAAAAARo/UzxA714UYCMEOeH7Zj8r6GDhgwZkBmU-wCPcBGAYYCw/s0/AddText_06-10-04.33.19.png";
	gbr4.src = imgFree;
}
tmbl1[3].onclick = function(){
	cnms.innerHTML = nmsx1[3];
	gbr1.src = "https://1.bp.blogspot.com/-6jc0ZQlreFs/YMYJWxR2cMI/AAAAAAAAAQ4/EDJmDoDYh3ENk4xBxxdAJBsXTKQiUMsRQCPcBGAYYCw/s0/AddText_06-10-04.48.30.png";
	gbr2.src = "https://1.bp.blogspot.com/-ABZYN4UDp0E/YMYJWwMej_I/AAAAAAAAARo/JdZ3Whq_KAwjcPdBui1oJhwsJgY9DGcgACPcBGAYYCw/s0/AddText_06-10-04.45.55.png";
	gbr3.src = "https://1.bp.blogspot.com/-a32g3-mzDeM/YMYJWV_pOPI/AAAAAAAAARI/jMDrAv7ZfVg-XlAEdGz-eDFfBGodFa9YACPcBGAYYCw/s0/AddText_06-10-04.43.26.png";
	gbr4.src = imgFree;
}
tmbl1[4].onclick = function(){
	cnms.innerHTML = nmsx1[4];
...
tmbl1[5].onclick = function(){
	cnms.innerHTML = nmsx1[5];
...
tmbl1[6].onclick = function(){
	cnms.innerHTML = nmsx1[6];
...
tmbl1[7].onclick = function(){
	cnms.innerHTML = nmsx1[7];
...
tmbl1[8].onclick = function(){
	cnms.innerHTML = nmsx1[8];
...
tmbl1[9].onclick = function(){
	cnms.innerHTML = nmsx1[9];
...
tmbl1[10].onclick = function(){
	cnms.innerHTML = nmsx1[10];
...
tmbl1[11].onclick = function(){
	cnms.innerHTML = nmsx1[11];
...
tmbl1[12].onclick = function(){
	cnms.innerHTML = nmsx1[12];
...
tmbl1[13].onclick = function(){
	cnms.innerHTML = nmsx1[13];
...
tmbl1[14].onclick = function(){
	cnms.innerHTML = nmsx1[14];
...
tmbl1[15].onclick = function(){
	cnms.innerHTML = nmsx1[15];
...
tmbl1[16].onclick = function(){
	cnms.innerHTML = nmsx1[16];
...
tmbl1[17].onclick = function(){
	cnms.innerHTML = nmsx1[17];
...
tmbl1[18].onclick = function(){
	cnms.innerHTML = nmsx1[18];
...
tmbl1[19].onclick = function(){
	cnms.innerHTML = nmsx1[19];
...
tmbl1[20].onclick = function(){
	cnms.innerHTML = nmsx1[20];
...
tmbl1[21].onclick = function(){
	cnms.innerHTML = nmsx1[21];
...
tmbl1[22].onclick = function(){
	cnms.innerHTML = nmsx1[22];
...
tmbl1[23].onclick = function(){
	cnms.innerHTML = nmsx1[23];
...
tmbl1[24].onclick = function(){
	cnms.innerHTML = nmsx1[24];
	gbr1.src = "https://1.bp.blogspot.com/-7i56pE-hEQg/YMYJ5ct1ZnI/AAAAAAAAARg/RXlOY5yv3Sgt6VsO0wyo-XpoS6tc9BChQCPcBGAYYCw/s0/AddText_06-10-11.27.43.png";
	gbr2.src = "https://1.bp.blogspot.com/-B2-JvWRdNas/YMYJ5URpt7I/AAAAAAAAARk/nyUyoHBbJWAr7A_4yOnNm--46QZD8kqmwCPcBGAYYCw/s0/AddText_06-10-11.30.02.png";
	gbr3.src = "https://1.bp.blogspot.com/-cU_aMqAUt30/YMYJ5mNCZSI/AAAAAAAAARk/-sFnW14M7FIbHan7lBFvqvxXqdbHwHVVACPcBGAYYCw/s0/AddText_06-10-11.32.13.png";
	gbr4.src = imgFree;
}
tmbl1[25].onclick = function(){
	cnms.innerHTML = nmsx1[25];
	gbr1.src = "https://1.bp.blogspot.com/-yfNvkBSG9mE/YMYJ6JRBmqI/AAAAAAAAARE/5ZtC38S5Te0W0ynkHlHQ1mJjjBdVaUMVwCPcBGAYYCw/s0/AddText_06-10-11.36.10.png";
	gbr2.src = "https://1.bp.blogspot.com/-phHLWkp_oFo/YMYJ69Hny_I/AAAAAAAAARU/XBERKlIENwwQVMiLEOziI_9uJb3YldRlQCPcBGAYYCw/s0/AddText_06-10-11.37.37.png";
	gbr3.src = "https://1.bp.blogspot.com/-EIllIn2IJV8/YMYJ7cMwcgI/AAAAAAAAARk/VjZt9t8M0tkUWmb7CKeXQbfCnWymTLZRwCPcBGAYYCw/s0/AddText_06-10-11.39.19.png";
	gbr4.src = imgFree;
}
tmbl1[26].onclick = function(){
	cnms.innerHTML = nmsx1[26];
	gbr1.src = "https://1.bp.blogspot.com/-dHxhtCpRj9c/YMYJ7WJHRwI/AAAAAAAAARU/FkVH6L37imcOkGXYxuRwhXLiAE0XZf8pQCPcBGAYYCw/s0/AddText_06-10-11.42.35.png";
	gbr2.src = "https://1.bp.blogspot.com/-s3ihHk2nJH0/YMYJ7kY72fI/AAAAAAAAAQ8/rieW7BuonBEYLJOTQpl3_euhOXHQIwpmwCPcBGAYYCw/s0/AddText_06-10-11.45.35.png";
	gbr3.src = "https://1.bp.blogspot.com/-xNa2A9b9o_Y/YMYJ9HWmEfI/AAAAAAAAARU/_lGYhgareGErggKJMR4lzQwcF_Uk9ehOQCPcBGAYYCw/s0/AddText_06-10-11.48.55.png";
	gbr4.src = imgFree;
}
tmbl1[27].onclick = function(){
	cnms.innerHTML = nmsx1[27];
	gbr1.src = "https://1.bp.blogspot.com/-R1xwGFF5rxE/YMYJ9ACVn2I/AAAAAAAAARM/MLeyxTNWtk8xmgVeSk2KnOzo6wct7L9ZACPcBGAYYCw/s0/AddText_06-10-11.51.57.png";
	gbr2.src = "https://1.bp.blogspot.com/-HSJdYKsQXZA/YMYJ9ON-SWI/AAAAAAAAARc/EUeuD9pZNaomayZxCZ728mcTcIswelMbgCPcBGAYYCw/s0/AddText_06-10-11.53.41.png";
	gbr3.src = "https://1.bp.blogspot.com/-0Coc3I-oLP4/YMYJ90vz0wI/AAAAAAAAAQ8/CwrESh82QN4DaPxHGNuHJmbZaLSA5mZtwCPcBGAYYCw/s0/AddText_06-10-11.55.20.png";
	gbr4.src = imgFree;
}
tmbl1[28].onclick = function(){
	cnms.innerHTML = nmsx1[28];
	gbr1.src = "https://1.bp.blogspot.com/-OdEuPNQ3E1M/YMYKWu5FhNI/AAAAAAAAARE/Ke4gCUj4CaU3TTQOZJZt6SpgOFw_DtFSQCPcBGAYYCw/s0/AddText_06-11-12.01.27.png";
	gbr2.src = "https://1.bp.blogspot.com/-a8-NnNEIO0M/YMYKXzSU3vI/AAAAAAAAARc/swZJGSe_qfEPmhfW816DGpcTAaqPmqUfgCPcBGAYYCw/s0/AddText_06-11-12.04.53.png";
	gbr3.src = "https://1.bp.blogspot.com/-fH0UcDTGXdI/YMYKYc212UI/AAAAAAAAARQ/oEA1n40_vLoQVYN3jV4PK3SYA6zgKpogACPcBGAYYCw/s0/AddText_06-11-12.06.44.png";
	gbr4.src = imgFree;
}
tmbl1[29].onclick = function(){
	cnms.innerHTML = nmsx1[29];
...
tmbl1[30].onclick = function(){
	cnms.innerHTML = nmsx1[30];
...
tmbl1[31].onclick = function(){
	cnms.innerHTML = nmsx1[31];
...
tmbl1[32].onclick = function(){
	cnms.innerHTML = nmsx1[32];
...
tmbl1[33].onclick = function(){
	cnms.innerHTML = nmsx1[33];
...
tmbl1[34].onclick = function(){
	cnms.innerHTML = nmsx1[34];
...
tmbl1[35].onclick = function(){
	cnms.innerHTML = nmsx1[35];
...
tmbl1[36].onclick = function(){
	cnms.innerHTML = nmsx1[36];
...
tmbl1[37].onclick = function(){
	cnms.innerHTML = nmsx1[37];
...
tmbl1[38].onclick = function(){
	cnms.innerHTML = nmsx1[38];
...
tmbl1[39].onclick = function(){
	cnms.innerHTML = nmsx1[39];
...
tmbl1[40].onclick = function(){
	cnms.innerHTML = nmsx1[40];
...
tmbl1[41].onclick = function(){
	cnms.innerHTML = nmsx1[41];
...
tmbl1[42].onclick = function(){
	cnms.innerHTML = nmsx1[42];
...
tmbl1[43].onclick = function(){
	cnms.innerHTML = nmsx1[43];
...
tmbl1[44].onclick = function(){
	cnms.innerHTML = nmsx1[44];
...
tmbl1[45].onclick = function(){
	cnms.innerHTML = nmsx1[45];
...
tmbl1[46].onclick = function(){
	cnms.innerHTML = nmsx1[46];
