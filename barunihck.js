...
var cnmsf = document.getElementById("tekschrd");
...
var gidc2f = document.createElement('div');
gidc2f.setAttribute("id","grd6");
document.getElementById("DIV6").appendChild(gidc2f);
for(f=0;f<36;f++){
...
var btnx2f = document.createElement("div");
btnx2f.innerHTML = nmsx2f[f];
btnx2f.setAttribute("class","koloms6");
document.getElementById("grd6").appendChild(btnx2f);
}
var tmbl2f = document.getElementsByClassName("koloms6");
tmbl2f[0].onclick = function(){
	cnmsf.innerHTML = nmsx2f[0];
...
tmbl2f[1].onclick = function(){
	cnmsf.innerHTML = nmsx2f[1];
...
tmbl2f[2].onclick = function(){
	cnmsf.innerHTML = nmsx2f[2];
...
tmbl2f[3].onclick = function(){
	cnmsf.innerHTML = nmsx2f[3];
...
tmbl2f[4].onclick = function(){
	cnmsf.innerHTML = nmsx2f[4];
...
tmbl2f[5].onclick = function(){
	cnmsf.innerHTML = nmsx2f[5];
...
tmbl2f[6].onclick = function(){
	cnmsf.innerHTML = nmsx2f[6];
...
tmbl2f[7].onclick = function(){
	cnmsf.innerHTML = nmsx2f[7];
...
tmbl2f[8].onclick = function(){
	cnmsf.innerHTML = nmsx2f[8];
...
tmbl2f[9].onclick = function(){
	cnmsf.innerHTML = nmsx2f[9];
...
tmbl2f[10].onclick = function(){
	cnmsf.innerHTML = nmsx2f[10];
...
tmbl2f[11].onclick = function(){
	cnmsf.innerHTML = nmsx2f[11];
...
tmbl2f[12].onclick = function(){
	cnmsf.innerHTML = nmsx2f[12];
...
tmbl2f[13].onclick = function(){
	cnmsf.innerHTML = nmsx2f[13];
...
tmbl2f[14].onclick = function(){
	cnmsf.innerHTML = nmsx2f[14];
...
tmbl2f[15].onclick = function(){
	cnmsf.innerHTML = nmsx2f[15];
...
tmbl2f[16].onclick = function(){
	cnmsf.innerHTML = nmsx2f[16];
...
tmbl2f[17].onclick = function(){
	cnmsf.innerHTML = nmsx2f[17];
...
tmbl2f[18].onclick = function(){
	cnmsf.innerHTML = nmsx2f[18];
...
tmbl2f[19].onclick = function(){
	cnmsf.innerHTML = nmsx2f[19];
...
tmbl2f[20].onclick = function(){
	cnmsf.innerHTML = nmsx2f[20];
...
tmbl2f[21].onclick = function(){
	cnmsf.innerHTML = nmsx2f[21];
...
tmbl2f[22].onclick = function(){
	cnmsf.innerHTML = nmsx2f[22];
...
tmbl2f[23].onclick = function(){
	cnmsf.innerHTML = nmsx2f[23];
...
tmbl2f[24].onclick = function(){
	cnmsf.innerHTML = nmsx2f[24];
...
tmbl2f[25].onclick = function(){
	cnmsf.innerHTML = nmsx2f[25];
...
tmbl2f[26].onclick = function(){
	cnmsf.innerHTML = nmsx2f[26];
...
tmbl2f[27].onclick = function(){
	cnmsf.innerHTML = nmsx2f[27];
...
tmbl2f[28].onclick = function(){
	cnmsf.innerHTML = nmsx2f[28];
...
tmbl2f[29].onclick = function(){
	cnmsf.innerHTML = nmsx2f[29];
...
tmbl2f[30].onclick = function(){
	cnmsf.innerHTML = nmsx2f[30];
...
tmbl2f[31].onclick = function(){
	cnmsf.innerHTML = nmsx2f[31];
...
tmbl2f[32].onclick = function(){
	cnmsf.innerHTML = nmsx2f[32];
...
tmbl2f[33].onclick = function(){
	cnmsf.innerHTML = nmsx2f[33];
...
tmbl2f[34].onclick = function(){
	cnmsf.innerHTML = nmsx2f[34];
...
tmbl2f[35].onclick = function(){
	cnmsf.innerHTML = nmsx2f[35];
